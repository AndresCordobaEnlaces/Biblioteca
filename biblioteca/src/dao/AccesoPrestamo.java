...
public class AccesoPrestamo {
	...
	/**
	 * Metodo que comprueba si un libro tiene un prestamo activo
	 * 
	 * @param codigoLibro
	 * @return
	 * @throws BDException
	...
	/**
	 * Consulta cuantas veces se ha prestado cada libro
	 * 
	 * @return
	 * @throws BDException
	 * @author AndresCordoba
	...
	public static LinkedHashMap<Libro, Integer> consultarNumeroDeVecesLibrosPrestados() throws BDException {
		...
		try {
			...
			String query = "select l.isbn, l.titulo, count(p.codigo_libro) as veces_prestado "
					+ "from libro l join prestamo p on p.codigo_libro = l.codigo " + "group by l.isbn, l.titulo "
	...
	/**
	 * Consulta cuantas veces ha pedido prestado cada socio
	 * 
	 * @return
	 * @throws BDException
	 * @author AndresCordoba
